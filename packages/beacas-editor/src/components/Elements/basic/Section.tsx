...
import { BlockManager, ElementType, StandardSectionElement } from "beacas-core";

const block = BlockManager.getBlockByType(ElementType.SECTION);

export class Section extends AtomSection<StandardSectionElement> {
  ...
  renderElement() {
    return (
      <div
        ...
        style={{
          maxWidth: this.isFullWidth()
            ? undefined
            : this.props.context.attributes.width,
          margin: "auto",
        }}
      >
